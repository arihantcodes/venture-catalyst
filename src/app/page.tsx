    ...
    <>
      ...
      <div>
        <div className="flex flex-col md:flex-row justify-center px-4 mt-12 ">
          <h1 className="text-3xl md:text-6xl font-bold text-transparent bg-clip-text  bg-gradient-to-r from-gradient-start via-gradient-middle to-gradient-end [-webkit-background-clip:text]  text-center">
            Why Choose
          </h1>
