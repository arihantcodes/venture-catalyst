      ...
      <div className="container mx-auto p-4 flex-grow">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="flex flex-col gap-4">
            <h1 className="text-xl font-bold bg-gradient-to-tr from-yellow-400 to-pink-800 text-transparent bg-clip-text">
              User Details
            </h1>
            ...
            <h1 className="text-4xl font-bold bg-gradient-to-tr from-yellow-400 to-pink-500 text-transparent bg-clip-text">
              Achievements
            </h1>
          ...
          <div className="flex flex-col items-center justify-center mt-10 sm:mt-0">
            <h1 className="text-4xl mb-8 text-center font-bold text-[#B32AC2]">
              Level
            </h1>
            <Image
              src="/level.svg"
