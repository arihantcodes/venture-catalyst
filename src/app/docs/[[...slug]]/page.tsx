  ...
  return (
    <div className="flex items-start gap-12">
      <div className="flex-[3] pt-10">
        ...
        <Markdown>
          <h1 className="flex flex-col m-4">{res.frontmatter.title}</h1>
          <p className=" flex flex-col ml-4  text-muted-foreground text-[16.5px]">
            {res.frontmatter.description}
          </p>
          <div className="flex flex-col m-4 gap-4">{res.content}</div>
